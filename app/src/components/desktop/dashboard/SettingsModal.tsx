                                    ...
                                    >
                                        <div className="flex flex-col items-center py-6 space-y-5">
                                            ...
                                            <div className="text-center space-y-3">
                                                <div>
                                                    <p className="text-sm font-semibold text-telegram-text">Aamir Usmani</p>
                                                    <p className="text-[11px] text-telegram-subtext mt-1">
                                                        Original open source by{' '}
                                                        <button
                                                            onClick={(e) => { e.preventDefault(); open('https://github.com/caamer20'); }}
                                                ...
                                                <button
                                                    onClick={(e) => { e.preventDefault(); open('https://github.com/usmaniaamir41-dotcom'); }}

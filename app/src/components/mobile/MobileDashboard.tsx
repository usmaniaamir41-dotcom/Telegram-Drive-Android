...
export default function MobileDashboard({ onLogout }: { onLogout?: () => void }) {
  ...
  return (
    <div className="absolute inset-0 flex flex-col bg-telegram-bg text-telegram-text overflow-hidden select-none font-sans">
      ...
      <header className="safe-pt-header flex items-center justify-between px-5 pb-4 bg-gradient-to-r from-telegram-hover/40 to-telegram-bg border-b border-telegram-border/60 shadow-lg backdrop-blur-md sticky top-0 z-40">
            ...
            <div className="p-4 rounded-2xl bg-telegram-hover/20 border border-telegram-border/30 space-y-4">
              ...
              <div className="flex flex-col items-center py-3 space-y-4">
                ...
                <div className="text-center space-y-2.5">
                  <p className="text-xs font-semibold text-telegram-text">Aamir Usmani</p>
                  <p className="text-[10px] text-telegram-subtext">
                    Original open source by{' '}
                    <button
                      onClick={(e) => { e.preventDefault(); openUrl('https://github.com/caamer20'); }}
                      className="text-telegram-primary hover:text-telegram-primary/80 transition-colors cursor-pointer"
                    >
                      @caamer20
                    </button>
                  </p>
                  ...
                  <button
                    onClick={(e) => { e.preventDefault(); openUrl('https://github.com/usmaniaamir41-dotcom'); }}
                  ...
                  >
                    ...
                    github.com/usmaniaamir41-dotcom
                  </button>
                </div>
      ...
      <div
        className={`fixed top-0 left-0 bottom-0 w-[280px] bg-telegram-surface border-r border-telegram-border/60 z-[110] shadow-2xl flex flex-col safe-pt-header pb-28 transition-transform duration-300 ease-out transform ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'
          }`}

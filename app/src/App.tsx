...
import { debugLog, isAndroidPlatform, getPlatformFlags, isLikelyPhoneUI } from "./utils";
...
function AppContent() {
  ...
  const showMobileDashboard = isMobile || isAndroidPlatform || platformFlags.isMobile || isLikelyPhoneUI();

  useEffect(() => {
    if (authStatus !== 'authenticated') return;
    // #region agent log
    debugLog('App.tsx:dashboard-route', 'dashboard selected', {
      isMobile,
      isAndroidPlatform,
      showMobileDashboard,
      os: platformFlags.os,
      authStatus,
      dashboard: showMobileDashboard ? 'MobileDashboard' : 'DesktopDashboard',
    }, 'H1');
    // #endregion
  }, [authStatus, isMobile, showMobileDashboard, platformFlags.os]);
